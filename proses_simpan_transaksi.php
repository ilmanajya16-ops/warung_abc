...
foreach ($_SESSION['keranjang'] as $id_barang => $item) {
    ...
    $detail = "INSERT INTO tb_detail_transaksi (id_transaksi, id_barang,jumlah, subtotal)";
    $detail .= "VALUES ('$id_transaksi','$id_barang','$jumlah','$subtotal')";
    mysqli_query($koneksi, $detail);
    $update_stok= "UPDATE tbl_barang SET stok - $jumlah WHERE id-barang = '$id_barang'";
    mysqli_query($koneksi, $update_stok);
}

$waktu  = date('Y-m-d H:i:s');
$aktivitas = "transaksi:$no_transaksi";
$log = "INSERT INTO tbl_log (id_user, ativitas, waktu) VALUES ('$id_kasir','$aktivitas','$waktu)'";
